...
def load_data():
    ...
    if "admin" not in data:
        data["admin"] = {"owner_password": ""}

    for business in data.get("businesses", []):
        if "client_password" not in business:
            business["client_password"] = ""
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        for b in data["businesses"]:
            if b.get("slug") == slug:
                keep_password = b.get("client_password", "")
...
if __name__ == "__main__":
    ...
    print("Configura admin.owner_password y los client_password en data/businesses.json antes de usar el panel.")
